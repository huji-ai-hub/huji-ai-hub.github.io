...
bodyHe: |
  ...
  - **שנה א: יסודות.** במתמטיקה (חשבון אינפיניטסימלי, אלגברה לינארית), הסתברות, וקורסי בסיס במדעי מחשב.
  - **שנה ב: ארגז כלים.** קורסי יסוד ב מדעי המחשב (אלגוריתמים, סיבוכיות חישובית), סטטיסטיקה, יסודות בלמידת מכונה ולמידה עמקה (רשתות נוירונים).
  - **שנה ג: התמחות ומחקר.** קורסים בחירה בבינה מלאכותית במגוון תחומים מתקדמים: מערכות בינה, ראייה ממוחשבת, עיבוד שפה טבעית, למידה חיזוקית, בטיחות AI. אפשרות להצטרף למעבדות מחקר של הסגל כעוזרי מחקר עוד בתואר ראשון.
---
